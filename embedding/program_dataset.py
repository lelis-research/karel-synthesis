...
def make_dataloaders(datadir, dsl: Production, device: torch.device, logger: logging.Logger, config: Config):
    ...
    train_dataset = ProgramDataset(train_program_list, dsl, device, config)
...
class ProgramDataset(Dataset):
    def __init__(self, program_list: list, dsl: Production, device: torch.device, config: Config):
        self.device = device
